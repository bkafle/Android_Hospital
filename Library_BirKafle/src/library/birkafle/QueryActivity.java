...
import library.birkafle.constant.SQLCommand;
import library.birkafle.util.DBOperator;
import library.birkafle.view.TableView;
...
public class QueryActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.query_birkafle);
    //copy database file
    try{
    ...
    public void onClick(View v)
	{
		...
		if (id==R.id.showresult_btn){
			...
			Intent intent = new Intent(this, BirKafleActivity.class);
